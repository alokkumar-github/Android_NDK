...
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_jnidemo_NativeLibrary_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
    std::string hello = "Hello from C++";
    return env->NewStringUTF(hello.c_str());
...
Java_com_example_jnidemo_NativeLibrary_passingDataToJni(JNIEnv *env,
                                                       jobject instance,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_jnidemo_NativeLibrary_passObjectToJNI(JNIEnv *env, jobject thiz,
...
Java_com_example_jnidemo_NativeLibrary_getObjectFromJNI(JNIEnv *env, jobject instance) {

    // Create a jclass from actual Java object class path
    jclass sampleObjClass = env->FindClass(
            "com/example/jnidemo/SampleDataObj");
...
Java_com_example_jnidemo_NativeLibrary_callTheCallBackMethod(JNIEnv *env, jobject instance) {
